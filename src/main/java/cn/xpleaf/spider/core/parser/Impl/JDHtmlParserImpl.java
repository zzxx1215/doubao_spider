...
//            // 当前页面的商品url列表 //*[@id="J_goodsList"]/ul/li[1]/div/div[4]/a/em //div[@id='plist']/ul/li/div/div[1]/a
//            List<String> urls = HtmlUtil.getListUrlByXpath(rootNode, "href", "//*[@id=\"J_goodsList\"]/ul/li/div/div[4]/a");
//            // 下一页 获取下一页的url //*[@id="J_bottomPage"]/span[1]/a[3] //div[@id='J_topPage']/a[2]
//            String nextUrl = HtmlUtil.getAttrByXpath(rootNode, "href", "//*[@id=\"J_bottomPage\"]/span[1]/a[3]");
